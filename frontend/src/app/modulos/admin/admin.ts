...
const SVG_MAP: Record<string, Array<{ d: string }>> = {
  ...
  'auditoria':         [{ d: 'M16 2.6667C8.6364 2.6667 2.6667 8.6364 2.6667 16C2.6667 23.3636 8.6364 29.3333 16 29.3333C23.3636 29.3333 29.3333 23.3636 29.3333 16C29.3333 8.6364 23.3636 2.6667 16 2.6667Z' }, { d: 'M16 8V16L21.3333 18.6667' }],
  'gestion-opciones':  [{ d: 'M16 4L4 10V22L16 28L28 22V10L16 4Z' }, { d: 'M16 16L4 10' }, { d: 'M16 16V28' }, { d: 'M16 16L28 10' }],
